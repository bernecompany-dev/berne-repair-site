 ...
 *  - Voice: factory-trained, white-glove luxury — this is the high-end sister
 *    of the mass-market site. Lead with the premium platforms (Sub-Zero, Wolf,
 *    Miele, Thermador, Viking, Gaggenau) and the affluent housing stock. Never
 *    use mass-market coupon framing ("$59 service call", "same-day" as a hook);
 *    price is a quiet, credited diagnostic, never the headline.
 */
...
export type ComboUnique = {
  /**
   * Hand-written SERP meta description — symptom + geo + premium signal,
...
export const COMBO_UNIQUE: Record<string, ComboUnique> = {
  ...
  [key("refrigerator-repair", "miami")]: {
    metaDescription:
      "Sub-Zero or built-in fridge down in Miami? White-glove repair of premium refrigeration, Brickell towers to Grove kitchens. Senior EPA-608 techs, 90-day warranty.",
    heroIntro:
      "Miami is the hardest city in America to be a refrigerator. Compressors run near-continuously against 90°F ambient heat, condenser coils clog with humidity-bound dust, and anything within a mile of Biscayne Bay corrodes years ahead of schedule. We are the high-end side of the house — factory-level service for Sub-Zero columns in Brickell towers, Thermador and Miele integrated units in the Grove, panel-ready built-ins serviced in place without a mark on the millwork. The diagnostic is a flat fee, credited in full toward the repair.",
    local: {
      ...
      paragraphs: [
        "Miami refrigerators live a different life than the spec sheet assumes. A unit rated for 70°F ambient spends half the year fighting 85-95°F kitchens, which means the compressor duty cycle roughly doubles and every marginal component — start relay, condenser fan, door gasket — fails sooner. Add salt-laden air in Edgewater, Mid-Beach, and anywhere east of Biscayne Boulevard, and condenser coils corrode and load up until the sealed system overheats. The single highest-value habit for a Miami fridge owner is an annual coil cleaning; it is also the first thing our technicians inspect on every warm-fridge call.",
        "The building stock shapes the work too. In Brickell and Downtown high-rises, most of what we see is built-in: Sub-Zero, Thermador, and panel-ready columns that have to be serviced in place — there is no 'wheel it to the curb' option on the 38th floor. Our senior techs handle service-elevator booking, COI paperwork for building management, and floor protection as standard procedure, because in a Brickell residence that discretion is half the job. In the Grove, Little Havana, and Edgewater's older low-rises it is the opposite problem: older freestanding units where the honest call is sometimes 'replace, don't repair' — and we will tell you that before you ever pay for a visit.",
        "Our dispatch routes technicians across the urban core all day, so a morning call from Wynwood or the Design District is generally seen the same afternoon, and the senior trucks carry what Miami's premium kitchens actually hold — Sub-Zero pivot kits and 4204490 filters, dual-evaporator fan motors, plus the OEM parts for the Thermador and Miele built-in segment. The flat diagnostic fee is credited toward the repair when you proceed.",
        "One Miami-specific warning: after summer grid flickers and hurricane-season outages, we get a wave of 'fridge dead after the power came back' calls. Nine times out of ten that is a control board or start device that took the surge — not the compressor. Don't let anyone condemn the unit before those two are tested; the difference is a $200-400 repair versus a four-figure replacement.",
      ],
      },
    nuances: [
      {
      ...
      },
      {
        ...
        body: "Miami ambient heat roughly doubles compressor runtime versus the design assumption. Marginal relays, fans, and gaskets fail sooner here — which is why our senior trucks carry them as standard stock.",
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Yes — built-in and panel-ready units (Sub-Zero, Thermador, Viking, Miele) in high-rises are the core of our Miami work. We handle the building logistics ourselves: certificate of insurance for your management company, service-elevator scheduling, and floor protection. Senior technicians handle the built-in segment exclusively.",
      },
      {
        question: "My fridge died after a power outage in Miami — is it the compressor?",
        answer:
          "Usually not. Post-outage failures are most often the start relay or the main control board, both of which take the surge before the compressor does. We test both at the diagnostic before anyone talks about replacing the unit, and the diagnostic fee is credited toward the repair when you proceed. A relay swap is often a single visit.",
      },
      {
        question: "How fast can you get to a refrigerator emergency in Miami?",
        answer:
          "A refrigerator full of spoiling food is a priority dispatch. Our technicians criss-cross the urban core all day, so Wynwood, Brickell, the Grove, and Little Havana are quick to reach — call early and we can usually be there the same afternoon. The diagnostic fee is credited toward the repair when you approve it.",
      },
    ],
  },
  ...
  [key("dryer-repair", "hallandale-beach")]: {
    metaDescription:
      "Dryer not heating in Hallandale Beach? Our headquarters is on N Federal Hwy — our quickest white-glove dispatch. Vent airflow checked, 90-day warranty.",
    heroIntro:
      "Hallandale Beach is home turf — our headquarters sits on N Federal Highway, which makes a dryer call here the shortest dispatch we run. Condo laundry closets in Three Islands and Golden Isles, stacked units in the beach towers, Miele and Bosch ventless heat-pump dryers in the newer residences: we see all of it, with a flat diagnostic credited toward the repair and most jobs closed on the first visit.",
    local: {
      eyebrow: "Dryer repair in Hallandale Beach — from the home office",
      heading: "The company headquarters is in this zip code",
      paragraphs: [
        "Berne Appliance Repair is headquartered at 1001 N Federal Hwy in Hallandale Beach, so 'how fast can you get here' has the best possible answer in this city: our technicians start and end their routes nearby, and a morning call almost always converts to a visit before the day is out. There is no travel-time padding in the schedule for Hallandale — Three Islands, Golden Isles, and Hallandale Park are minutes from the office.",
        ...
        "For the premium segment — Miele and Bosch ventless heat-pump dryers are increasingly common in newer Hallandale residences — drainage faults and sensor failures go to a senior tech, because ventless platforms diagnose very differently from a belt-and-fuse machine. Either way the structure is the same: a flat diagnostic, credited to the repair when you proceed, and a 90-day warranty on parts and labor.",
      ],
    },
    nuances: [
      {
        title: "HQ dispatch advantage",
        body: "Our main office is on N Federal Hwy in Hallandale Beach. Dryer calls here get the tightest scheduling windows we can offer anywhere in South Florida.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Faster than anywhere else we serve — our headquarters is at 1001 N Federal Hwy in Hallandale Beach. Call early and a visit that same day is the norm, not the exception. The diagnostic fee is credited toward the repair when you approve it.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Honest answer: you don't until someone looks inside. Dust resettling within a day, indoor allergies, musty smell at startup, and visible dust plumes at the registers are real indicators — but we verify with a camera inspection as part of the visit before recommending anything. If the ducts are clean, we say so, and the diagnostic fee is credited toward any work you approve.",
      },
      {
        question: "Do you clean dryer vents in Greenacres too?",
        answer:
          "Yes, and we recommend doing it on the same visit. Greenacres single-story homes typically have long horizontal dryer vent runs, and years of lint buildup is the most common cause of two-cycle drying — and the leading cause of dryer fires. Bundling it with duct cleaning is the cheapest way to get both done.",
      },
    ],
  },
  ...
  [key("microwave-repair", "hialeah")]: {
    ...
    local: {
      ...
      paragraphs: [
        "The microwave failures we see in Hialeah are concentrated in over-the-range units — they are in most kitchens here, and they live directly above the steam and grease of stovetops that get real daily use. Steam migrates into the control panel and door-switch cavity; a few years of it and you get the classic Hialeah trio: buttons that stop responding, a unit that runs but doesn't heat (magnetron or its diode), and door switches that fail from tens of thousands of open-close cycles. All three are repairable, and door switches are a single-visit fix from truck stock.",
        "The honest-math conversation matters with microwaves more than any other appliance, and we have it up front. A countertop unit is usually not worth a service call — we will tell you that on the phone. But OTR and built-in units are a different story: replacement means installation, trim kits, and sometimes cabinet work, so a $150-300 repair on a quality unit beats a $600+ replace-and-install. GE, Whirlpool, and Samsung OTR platforms — the bulk of Hialeah's installed base — have well-stocked, affordable parts channels, which keeps repairs on the sensible side of that line.",
        "Our Hialeah customers often prefer service in Spanish — no problem. Llámenos y le atendemos en español, desde el diagnóstico hasta la factura. The flat diagnostic is credited toward the repair, and every job carries a 90-day parts-and-labor warranty either way.",
      ],
    },
    nuances: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Usually yes. Unlike a countertop unit, replacing an OTR microwave means installation labor, mounting, and sometimes a trim kit — so the true replacement cost is far above the sticker price. Most OTR repairs (door switches, diodes, magnetrons on common GE/Whirlpool/Samsung platforms) land between $150 and $300, the sensible side of the math.",
      },
      {
        question: "¿Ofrecen reparación de microondas en Hialeah en español?",
        answer:
          "Sí. Puede llamar y hacer todo el proceso en español — el despacho, el diagnóstico del técnico y la factura. La visita técnica es una tarifa fija que se acredita a la reparación, con garantía de 90 días en piezas y mano de obra.",
      },
    ],
  },
  ...
  [key("refrigerator-repair", "hialeah")]: {
    metaDescription:
      "Fridge warm or leaking in Hialeah? We keep 10-20-year-old units alive with OEM parts and honest math — part number on every invoice. 90-day warranty. En español.",
    heroIntro:
      "Hialeah's refrigerators are survivors — many of the homes around West Hialeah and Palm Springs North still run units that are 10, 15, even 20 years old, and owners here want them fixed, not replaced. That is work we respect and know how to do: honest diagnostics, OEM parts with the number printed on your invoice, and straight talk when a repair genuinely isn't worth it. En español si lo prefiere.",
    local: {
      ...
      paragraphs: [
        "Hialeah gives us a different refrigerator population than the coastal condos: freestanding top-freezer and side-by-side units, many past their tenth birthday, often with a second fridge sweating it out in the garage. That second-fridge pattern matters — a garage in Hialeah summer runs well above any refrigerator's rated ambient, so compressor start components, condenser fans, and door gaskets on garage units fail at two or three times the indoor rate. If your garage fridge is clicking and not starting, it is almost always the start relay, and that is a single-visit repair from truck stock.",
        "On older units the repair-or-replace line is where trust gets earned. Our rule, stated before we ever drive out: if the failure is a compressor or sealed-system leak on a 12+ year-old freestanding unit, we will tell you on the phone that replacement likely wins, and you have spent nothing. But most of what kills these fridges is far cheaper — defrost heaters, thermistors, fan motors, relays — parts in the $150-350 installed range that buy the unit years. We put the OEM part number on every invoice so you can verify exactly what went in.",
        "Hard water and decades-old supply lines in Hialeah's housing stock also mean ice-maker and water-valve work is constant here: clogged inlet screens, scaled valves, slow dispensers. It is unglamorous work that takes thirty minutes and saves a floor from the slow leak you haven't noticed yet. Y sí — todo el servicio está disponible en español, del diagnóstico a la garantía de 90 días.",
      ],
    },
    nuances: [
      {
        title: "Garage fridges die young",
        body: "Hialeah garage heat runs far above rated ambient — start relays, condenser fans, and gaskets fail at multiples of the indoor rate. The click-but-no-start symptom is usually a single-visit relay fix.",
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Constantly. Garage units in Hialeah heat work much harder than the kitchen fridge and burn through start relays, condenser fans, and door gaskets faster. Most garage-fridge failures are inexpensive component swaps we finish in one visit — the diagnostic fee is credited toward the repair either way.",
      },
    ],
  },
  ...
  [key("garbage-disposal-repair", "key-biscayne")]: {
    metaDescription:
      "Disposal jammed or leaking on Key Biscayne? One trip over the bridge, fully provisioned — repair parts and a stainless replacement both ride along. 90-day warranty.",
    heroIntro:
      "Key Biscayne is one bridge from the mainland, and that bridge is exactly why disposal calls here get planned right: our techs arrive with both repair parts and a stainless-chambered replacement unit on the truck, so a corroded InSinkErator in a Cape Florida kitchen is resolved in one trip — repair or swap, your call after the diagnostic.",
    local: {
      ...
      paragraphs: [
        ...
        "Because the island is a single-causeway trip, we run Key Biscayne calls fully provisioned — diagnosis, repair parts, and a replacement unit all ride along, so whichever way the diagnostic points, the job finishes that visit. That matters doubly for the island's condo stock near Crandon, where building water shut-off windows and dock/elevator rules make a second visit genuinely painful to schedule.",
        "Two pieces of free island-specific advice: run the disposal with cold water for a few extra seconds after grinding (it clears the trap and slows odor buildup in humid kitchens), and if the unit hums without turning, stop hitting reset — that is a jam or a seized bearing, and repeated resets cook the motor windings. The hex-key fix for a simple jam takes us minutes; a cooked motor is a replacement.",
      ],
    },
    nuances: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Stop pressing reset first — repeated resets on a jammed unit burn the motor. A hum usually means a jam or seized bearing: a jam is a minutes-long fix at the diagnostic; a seized bearing on a corroded island unit usually points to replacement, and we carry stainless-chambered units on the truck so it is done the same visit.",
      },
      {
        question: "Why do garbage disposals fail faster on Key Biscayne?",
        answer:
          "Salt air. Even under a sink cabinet, the island's salt-laden humidity corrodes the disposal's housing, flange, and internal steel years ahead of an inland unit. Stainless-chamber models last meaningfully longer here, and that is what we stock for island replacements.",
      },
    ],
  },
    ...
    faqs: [
      {
        ...
        answer:
          "Yes — integrated European units are the majority of our Bal Harbour dishwasher work. Senior technicians handle panel-ready removal with the manufacturer's procedure, and we arrange your building's COI and service-elevator requirements in advance. The diagnostic fee is credited toward the repair when you approve it.",
      },
      {
  ...
  [key("air-duct-cleaning", "bay-harbor-islands")]: {
    metaDescription:
      "Musty AC or damp vents in Bay Harbor Islands? HEPA duct cleaning for condo risers and shared closets, photo-documented, association paperwork handled. 90-day warranty.",
    heroIntro:
    ...
    local: {
      ...
      paragraphs: [
        ...
        "Working in occupied condo residences on a small island takes more care than a suburban attic crawl: we protect floors and furnishings, run the negative-pressure machine from the unit or the hallway as building rules allow, and handle association requirements — COI, elevator pads, work-hour windows — before the appointment. You get before/after photos of your actual duct interiors, which double as documentation for your association if the contamination source turns out to be building-side.",
        "If anyone in the household has allergies that flare indoors, ask us to inspect the air handler closet specifically. In Bay Harbor's humidity, a fouled evaporator coil or a rusted, never-cleaned condensate pan upstream of your supply ducts will re-contaminate freshly cleaned duct in months. We would rather fix the cause and have the cleaning last years.",
      ],
    },
    nuances: [
      {
  ...
  [key("washer-repair", "kendall")]: {
    metaDescription:
      "Washer not draining or spinning in Kendall? Senior techs, parts for LG, Samsung and Whirlpool, most jobs one visit. Honest bearing-job math, 90-day warranty.",
    heroIntro:
      "Kendall is family-laundry country — high-capacity top-loaders and front-load pairs in Kendall Lakes and the Hammocks running loads daily, not weekly. Heavy duty cycles surface every weak point a washer has, and we've repaired all of them: factory-trained techs, trucks stocked for the Whirlpool, LG, and Samsung platforms that dominate these neighborhoods, most jobs finished on the first visit.",
    local: {
    ...
    faqs: [
      {
        ...
        answer:
          "On the Whirlpool/Maytag platforms common in Kendall, that exact symptom is usually the shift actuator — the most frequent single-part washer repair we do. The part is on the truck and the job runs 45-60 minutes. The diagnostic confirms it before any work starts and is credited toward the repair.",
      },
      {
  ...
  [key("dryer-repair", "delray-beach")]: {
    metaDescription:
      "Dryer taking two cycles in Delray Beach? We measure vent airflow on every call — the usual culprit here. Honest fixes, parts on the truck, 90-day warranty.",
    heroIntro:
      "Delray Beach dryers split into two populations: condo and townhome units near Atlantic Avenue with long, lint-choked vent runs, and the laundry rooms of the Lake Ida and Tropic Isle single-family streets where machines run a decade past their warranty. Both get the same treatment — a diagnostic that always includes an airflow check, because in Delray the vent is guilty until proven innocent.",
    local: {
      ...
      paragraphs: [
        ...
        "Salt-side caveat for the barrier-island and Intracoastal streets: exterior vent caps corrode and their flapper dampers seize, which both restricts airflow and lets humid air drift back into the duct. It is a five-minute check we do on every coastal Delray call, and replacing a seized cap is one of the cheapest meaningful repairs in the book.",
      ],
    },
    nuances: [
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes — gas units in Delray's single-family neighborhoods are routine work. The common no-heat cause is a weakened igniter or failed gas-valve coils, both of which we test by amp draw and resistance at the diagnostic. Igniters and coil pairs for the major brands are truck-stock items.",
      },
    ],
  },
    ...
    faqs: [
      {
        ...
        answer:
          "It is the most common gas-oven failure and the design is protecting you: a weakened igniter can't open the gas safety valve, so gas isn't flowing. The fix is an igniter replacement — about thirty minutes, parts on the truck. If you ever smell gas while the oven is off, that is a different situation: ventilate and call your gas utility first.",
      },
      {
  ...
  [key("washer-repair", "miami")]: {
    metaDescription:
      "Washer stuck mid-cycle in Miami? Condo stackables to full-size pairs — building logistics handled, leaks prioritized. Senior techs, 90-day warranty.",
    heroIntro:
      "Washer repair in Miami spans two different worlds: stacked and ventless combos squeezed into Brickell and Edgewater condo closets, and full-size pairs in the Grove, Shenandoah, and Little Havana. We service both daily — condo building logistics handled for you, and trucks stocked for the LG, Samsung, and Whirlpool platforms that dominate the city.",
    local: {
      ...
      paragraphs: [
        ...
        "A word on urgency Miami owners already understand: in a condo, a leaking washer is never just your problem — it is the unit below's problem within the hour. Door-boot tears and weeping supply hoses get priority dispatch, and if you see water, shutting the unit's supply valves before we arrive is the best five-second favor you can do yourself.",
      ],
    },
    nuances: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Yes — tight-clearance stacked units are the bread and butter of our Miami condo work. Techs carry the slim tooling for closet extraction, and we handle your building's COI and service-elevator requirements before the visit. The diagnostic fee is credited toward the repair when you approve it.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Usually the building's vent path, not your dryer. Tower units exhaust through long risers or shared ducts that may never have been cleaned, and restricted airflow turns one cycle into three while quietly overheating the machine. We measure airflow at the diagnostic, fix what's reachable, and give you written documentation if the restriction is building-side.",
      },
      {
        question: "Do you repair ventless condenser dryers in Miami condos?",
        answer:
          "Yes — ventless units are standard in newer Miami towers and a regular part of our routes. Their failures (clogged heat exchangers, condensate pumps, humidity sensors) need platform-specific diagnosis, which is exactly why they go to our techs trained on those machines. Most repairs finish in a single visit.",
      },
    ],
  },
  ...
  [key("refrigerator-repair", "fort-lauderdale")]: {
    metaDescription:
      "Fridge warm in Fort Lauderdale? Salt-canal corrosion is the local killer — Sub-Zero and Thermador built-ins, senior EPA-608 techs. 90-day warranty.",
    heroIntro:
  ...
  [key("refrigerator-repair", "kendall")]: {
    metaDescription:
      "Fridge or ice maker down in Kendall? French-door family workhorses fixed in one visit, parts on the truck. Filter-first ice-maker triage, 90-day warranty.",
    heroIntro:
      "Kendall fridges feed real households — French-door workhorses in Kendall Lakes and the Hammocks opened a hundred times a day, ice makers that never get a rest, and a second fridge in half the garages. We keep them running: LG/Samsung/Whirlpool parts stocked on the truck, and most repairs finished the same visit they are diagnosed.",
    local: {
      ...
      paragraphs: [
        ...
        "Ice makers deserve their own paragraph here because Kendall households genuinely depend on them. Hard water scales inlet valves and clogs their screens; optic sensors film over; harvest motors seize. Most ice-maker failures are $150-300 repairs, and we will always check the water filter first — an overdue filter starves flow and mimics a dying valve, and it is the five-minute test that has saved plenty of Kendall customers a part they didn't need.",
        "The garage second-fridge gets the same honesty we give in Hialeah: garage heat doubles compressor workload, start relays and condenser fans fail early, and the click-click-click of a relay-locked compressor is a single-visit, truck-stock fix. A genuinely failed compressor on an aging garage unit, on the other hand, gets you straight numbers at the diagnostic — sometimes the right call is promoting the kitchen fridge's replacement to the garage instead.",
      ],
    },
    nuances: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          "That is the textbook symptom of the twin-cooling evaporator fan icing over — a Samsung French-door classic we see constantly in Kendall. The fix is a proper defrost of the duct plus a fan motor if it is damaged, and it is single-visit work with parts from the truck. The diagnostic confirms it before we start.",
      },
      {
  ...
  [key("washer-repair", "hialeah")]: {
    metaDescription:
      "Washer problems in Hialeah? Hard-working top-loaders repaired with OEM parts and honest pricing — en español. Part number on every invoice, 90-day warranty.",
    heroIntro:
      "Hialeah laundry rooms keep machines longer and work them harder than anywhere in Miami-Dade — top-loaders with a decade of daily cycles, repaired, passed along, and repaired again. That is our kind of work: OEM part numbers printed on the invoice, honest math on every repair, y todo el servicio disponible en español.",
    local: {
      ...
      paragraphs: [
        ...
        "We know many Hialeah machines are family workhorses that earn their keep, so the repair-or-replace talk comes with real numbers, not a sales pitch — and with the OEM part number on your invoice so you can verify exactly what was installed. Si prefiere hacer todo el proceso en español — el diagnóstico, la explicación y la factura — así lo hacemos. La visita técnica es una tarifa fija que se acredita a la reparación, con garantía de 90 días.",
      ],
    },
    nuances: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Usually the opposite. Slow filling in Hialeah is most often sediment from older supply lines packing the inlet-valve screens — a ten-minute cleaning, not a part. We check the screens before condemning the valve or board; if the valve solenoid has genuinely failed, that is still a modest single-visit repair.",
      },
      {
        question: "¿Reparan lavadoras en Hialeah con servicio en español?",
        answer:
          "Sí, completamente. Puede llamar, recibir el diagnóstico del técnico y la factura todo en español. La visita técnica es una tarifa fija que se acredita a la reparación, y todo el trabajo lleva garantía de 90 días en piezas y mano de obra.",
      },
    ],
  },
  ...
  [key("refrigerator-repair", "boca-raton")]: {
    ...
    nuances: [
      ...
      },
      {
        ...
        body: "Zone drift on Sub-Zero 424/427/430 units gets caught early — long before a warm zone costs you the collection it protects.",
      },
    ],
    faqs: [
      {
  ...
  [key("washer-repair", "hollywood")]: {
    metaDescription:
      "Washer leaking or not spinning in Hollywood? Priority dispatch from our Hallandale HQ next door — beach towers to the Hills. Honest fixes, 90-day warranty.",
    heroIntro:
      "Hollywood washers split by geography: full-size pairs in the Hollywood Hills and Emerald Hills ranch homes, stacked units in the beach towers along A1A, and everything in between across Hollywood Lakes. We run this city daily from our Hallandale Beach headquarters next door — priority dispatch on early calls, 90-day warranty on everything we touch.",
    local: {
      eyebrow: "Washer repair in Hollywood",
      heading: "Next door to headquarters, and we know the housing stock",
      paragraphs: [
        "Hollywood sits directly north of our Hallandale Beach headquarters, which makes it one of the fastest dispatches on our map — techs cross into Hollywood Lakes and the Hills all day, and a morning call here rarely waits past the afternoon. The housing tells us what we will find before we arrive: the mid-century ranch homes of Hollywood Hills and Emerald Hills run full-size top-loaders and front-load pairs with real mileage, while the beach corridor's condo towers run stacked and compact units with the building-access choreography we handle as routine — COI, elevator, protective runners.",
        "On the single-family side, the failure list is the honest classics: Whirlpool/Maytag shift actuators (fills, counts, never spins), drain pumps fouled by coins and grit, suspension rods on aging top-loaders that let the drum bang through spin like a kettledrum. All truck-stock, all single-visit fixes in most cases. The beach-side towers add the salt variable — fasteners and valve bodies corrode faster within blocks of the Atlantic — and stacked units' tight closets mean leaks hide until they are the downstairs neighbor's ceiling, so anything weeping gets priority dispatch.",
        "Hollywood Lakes' older plumbing deserves its own line: original galvanized supply lines in some of these streets shed scale that packs washer inlet screens, the trickle-fill complaint we clear in ten minutes. If your machine fills slowly and you are in an older Lakes home, mention it when you call — it is often the whole problem, and a ten-minute fix is the cheapest repair in the book.",
      ],
    },
    nuances: [
      {
        title: "HQ-adjacent dispatch",
        body: "Hollywood is the next city up from our Hallandale Beach headquarters — priority windows on early calls are the norm.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Hollywood borders our Hallandale Beach headquarters, so it is one of our fastest dispatch zones — call early and a visit that same day is the norm. The diagnostic fee is credited toward the repair when you approve it, with a 90-day parts-and-labor warranty on the work.",
      },
      {
        question: "My washer in an older Hollywood Lakes home fills very slowly — big problem?",
        answer:
          "Probably a small one. Older galvanized supply lines in parts of Hollywood Lakes shed scale that packs the washer's inlet screens — a ten-minute cleaning restores full flow. We check the screens before condemning any parts; if a valve solenoid has genuinely failed, that is still a modest single-visit repair.",
      },
    ],
  },
  ...
  [key("dryer-repair", "pembroke-pines")]: {
    metaDescription:
      "Dryer squealing or not heating in Pembroke Pines? 90s-vintage units are our specialty — belts and rollers stocked, airflow checked. 90-day warranty.",
    heroIntro:
      "Pembroke Pines is planned-community territory — SilverLakes, Chapel Trail, Pembroke Falls — where '90s-vintage homes mean '90s-vintage laundry rooms and dryers that have quietly worked for years past their warranty. We keep them safe and running: vent airflow checked on every call, belts and rollers on the truck for the platforms these neighborhoods run.",
    local: {
      eyebrow: "Dryer repair in Pembroke Pines",
      heading: "Planned communities, aging vents, predictable fixes",
      paragraphs: [
        "Pembroke Pines built out fast in the late '80s and '90s, and that cohort of homes — SilverLakes, Chapel Trail, Pembroke Falls, Pembroke Shores — now runs dryer vents that are decades old. Many of these single- and two-story layouts route exhaust through long under-roof runs to a side wall, and twenty-plus years of lint in foil-flex transitions and crushed elbows is the root cause behind most of what we are called for: two-cycle drying, blown thermal fuses, dryers shutting down hot mid-cycle. We measure airflow on every diagnostic and quote vent cleaning honestly when that is the actual fix — replacing a fuse without clearing the duct is a repeat appointment with extra steps.",
        "The machines themselves are the familiar suburban fleet — Whirlpool, Maytag, Samsung, LG, electric almost across the board — and their wear parts fail on schedule: idler pulleys that shriek, drum rollers that thump on rotation, belts that snap after years of service. These are single-visit repairs from truck stock, typically 45 minutes door to door. Where homes have been remodeled and gas lines added, the gas units follow the standard playbook: weak igniters amp-tested at the diagnostic, valve coils replaced as a pair.",
        "Worth knowing in a two-story Pines home: if your laundry is upstairs, vent runs are longer and lint settles at every bend — and a restricted upstairs vent is both an efficiency drain and a genuine fire consideration. If the top of your dryer is hot to the touch or the laundry room feels like a sauna mid-cycle, book the vent check; it is the cheapest meaningful safety work we do.",
      ],
    },
    nuances: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          "That is the thermal cutoff protecting you from a restricted vent. The dryer overheats because air can't move, shuts down, cools, and runs again — until the cutoff fails permanently. We measure airflow at the diagnostic and fix the restriction along with any heat-damaged parts; in '90s-era Pines homes the vent run is the usual culprit.",
      },
      {
        question: "How long should a dryer repair take in Pembroke Pines?",
        answer:
          "Most of what these neighborhoods need — belts, idler pulleys, drum rollers, thermal fuses, igniters on gas units — is single-visit work from truck stock, typically about 45 minutes once diagnosed. Call early and SilverLakes, Chapel Trail, and Pembroke Falls usually get same-day windows.",
      },
    ],
  },
  ...
  [key("refrigerator-repair", "west-palm-beach")]: {
    metaDescription:
      "Fridge failing in West Palm Beach? El Cid bungalows to Downtown towers — EPA-608 techs, dedicated 561 line. Storm-surge board testing, 90-day warranty.",
    heroIntro:
      "West Palm Beach refrigeration spans historic El Cid bungalows, Flamingo Park's restored 1920s homes, Northwood cottages, and the new Downtown towers — four different fridge populations in one city. We service all of them from our Palm Beach County dispatch, with a dedicated 561 line, EPA-608 certified techs, and senior attention to the premium built-in stock.",
    local: {
      eyebrow: "Refrigerator repair in West Palm Beach",
      heading: "Historic districts, new towers, and everything between",
      paragraphs: [
        "Few cities we serve mix refrigerator generations like West Palm Beach. The historic districts — El Cid, Flamingo Park, Grandview Heights — pair lovingly restored 1920s houses with kitchens that range from brand-new panel-ready columns to faithful twenty-year-old units that owners rightly want kept alive. Downtown WPB's new towers run builder-grade stainless French-doors by the hundreds, with the condo logistics we handle daily. And Northwood's cottages carry the honest older freestanding stock where repair-or-replace math matters most. Each population gets its own playbook, and all of them get straight numbers at the diagnostic.",
        "Two technical notes specific to this city. First, historic-district electrical: older homes that haven't had panel upgrades produce the brownout-and-surge conditions that kill control boards and start devices — if your fridge died during a storm week, suspect the board and relay before the compressor, because that is usually what we find. Second, the new Downtown towers' builder-grade units fail young and identically — ice maker assemblies, evaporator fans, board relays in the same models across entire buildings — which means we have usually seen your exact failure in your exact floor plan before, and the part is often already on the truck.",
        "Our Palm Beach County dispatch runs on its own 561 line — (561) 858-9919 — backed by the Boca Raton office south of you. Call early and West Palm addresses from Northwood to Grandview Heights usually land a same-day window, with the 90-day parts-and-labor warranty on every repair.",
      ],
    },
    nuances: [
      {
      ...
      },
      {
        ...
        body: "(561) 858-9919 routes Palm Beach County directly, backed by the Boca Raton office. Early calls usually get same-day windows.",
      },
    ],
    faqs: [
      {
