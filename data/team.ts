...
export const TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    specialty: "Refrigerant systems · Walk-ins · Leak detection",
    years: 5,
  ...
  },
  {
    ...
    specialty: "Sealed-system & refrigeration",
    years: 4,
    photo: "/images/team/hasrat-yusifov.webp",
    bio: "Factory-trained appliance technician focused on sealed-system and refrigeration repair. Completed hands-on sealed-system service training (TMM Academy) and pro-tech appliance training (Big City Appliance Repair School).",
    featured: false,
    givenName: "Hasrat",
    familyName: "Yusifov",
    languages: ["English", "Russian"],
  ...
  {
    slug: "vasyl-kruchkovskyi",
    name: "Vasyl Kruchkovskyi",
    role: "Service Technician",
    specialty: "Residential appliance repair",
    years: 6,
    photo: "/images/team/vasyl-kruchkovskyi.webp",
    bio: "Service technician handling residential appliance diagnostics and repair across refrigerators, washers, dryers, ovens and dishwashers.",
    featured: false,
    givenName: "Vasyl",
    familyName: "Kruchkovskyi",
    credentials: [EPA],
