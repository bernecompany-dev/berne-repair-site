...
export const en = {
  ...
  hero: {
    ...
    bodySuffix: " — free if you say go ahead with the repair.",
    ...
    priceCardSuffix: "flat · free with repair",
  },
  cta: {
    callPrefix: "Call",
    book: "Book online",
  ...
  processSteps: {
    ...
    s2Body: "Tech arrives, finds the root cause, quotes the repair. Free if you say go — you only pay the $59 if you decline.",
    s2Tag: "Today",
  ...
  whyReasons: [
    ...
    { title: "Honest diagnosis, $59 flat", body: "Up-front pricing. The service call is free if you say go ahead with the repair — you only pay it if you decline." },
