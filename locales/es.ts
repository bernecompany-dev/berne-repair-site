...
export const es: Dictionary = {
  ...
  hero: {
    ...
    bodySuffix: " — gratis si decide proceder con la reparación.",
    ...
    priceCardSuffix: "fijo · gratis con la reparación",
  },
  cta: {
    callPrefix: "Llamar",
  ...
  brands: {
    ...
    footnote: "Además de {brands} y la mayoría de las marcas residenciales y comerciales.",
  },
  team: {
    eyebrow: "El equipo",
  ...
  leadForm: {
    title: "Solicite servicio el mismo día",
  ...
  statsStrip: {
    ...
    priceSub: "Gratis con la reparación",
  ...
  processSteps: {
    ...
    s1Body: "Un número, un minuto. Le encontramos un horario el mismo día o mañana temprano.",
    s1Tag: "0 min",
    s2Title: "Diagnóstico $59",
    s2Body: "El técnico llega, encuentra la causa, cotiza la reparación. Gratis si dice que sí — solo paga los $59 si decide no continuar.",
    s2Tag: "Hoy",
  ...
  whyReasons: [
    ...
    { title: "Diagnóstico honesto, $59 fijo", body: "Precios claros. La visita técnica es gratuita si dice que sí a la reparación — solo se paga si decide no continuar." },
