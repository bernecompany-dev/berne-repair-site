...
export const alt = "City service area OG image";
...
export default async function OG({ params }: { params: Promise<{ city: string }> }) {
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          >
            {`Appliance Repair in ${city.name}, FL`}
          </div>
          <div style={{ fontSize: 34, color: "#94a3b8", maxWidth: 980, lineHeight: 1.3 }}>
            {`${city.county} County · ${city.neighborhoods.slice(0, 3).join(" · ")}`}
          </div>
        </div>
