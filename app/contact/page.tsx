...
export const metadata: Metadata = {
  ...
  description: `Reach Berne Appliance Repair dispatch for premium appliance service across South Florida. ${COMPANY.phone.display}. White-glove dispatch, licensed & insured.`,
  alternates: {
    canonical: "/contact",
    languages: {
