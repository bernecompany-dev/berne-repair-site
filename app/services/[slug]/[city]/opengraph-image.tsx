...
export const alt = "Service x City OG image";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div style={{ fontSize: 32, color: "#94a3b8", maxWidth: 980, lineHeight: 1.3 }}>
            {`${city.county} County · ${service.brands.slice(0, 3).join(", ")} and every major brand`}
          </div>
        </div>
